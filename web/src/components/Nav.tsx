...
function Nav(props: NavProps) {
  ...
  return (
    <div className="flex flex-col of-hidden min-w-60 w-60 pt3">
      <div className="flex items-center mx5 mb3 justify-between b-2 b-color-gray b-op-20 b-rd relative">
        <input
      ...
      <div className="of-hidden of-y-auto h-full pl5">
        {matchProblems.map(({ title }, index) => {
          return (
            <a
